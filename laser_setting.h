...
public:
    ...
    laser_device_manager *get_manager();
private:
...
private slots:
    ...
    void on_sample_horizontalSlider_sliderMoved(int position);
    void on_sample_spinBox_valueChanged(int arg1);
    void on_min_horizontalSlider_sliderMoved(int position);
    void on_min_spinBox_valueChanged(int arg1);
    void on_max_horizontalSlider_sliderMoved(int position);
