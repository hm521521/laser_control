...
void stage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (stage::*)(const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&stage::resultReady)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (stage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&stage::stage_finish)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void stage::resultReady(const int _t1)
{
