...
struct qt_meta_stringdata_track_panel_t {
    QByteArrayData data[4];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_track_panel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_track_panel_t qt_meta_stringdata_track_panel = {
    {
QT_MOC_LITERAL(0, 0, 11), // "track_panel"
QT_MOC_LITERAL(1, 12, 14), // "slotRemoveItem"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 4) // "flag"

    },
    "track_panel\0slotRemoveItem\0\0flag"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_track_panel[] = {
...
void track_panel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<track_panel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotRemoveItem((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject track_panel::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_track_panel.data,
    qt_meta_data_track_panel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *track_panel::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *track_panel::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_track_panel.stringdata0))
        return static_cast<void*>(this);
...
int track_panel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
