...
//                str_len=0;
//                strin.read((char*)&str_len,sizeof(unsigned char));
//                strin.ignore(str_len);//跳过scene_name数据
//                int effect_count = 0;
//                strin.read((char*)&effect_count, sizeof(int));//读有多少effect数据
//                for (int i = 0; i < effect_count; i++)
//                {
//                    strin.ignore(sizeof(int)*8);
//                    int picture_count=0;
//                    strin.read((char*)&picture_count, sizeof(int));
...
//                        {
//                            strin.ignore(sizeof(int)*2+sizeof(unsigned char)*3);
//                        }
//                    }
//                }
//                scene_count++;
