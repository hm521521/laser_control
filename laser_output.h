...
public:
    ...
    void send_data(unsigned char *settings_data, std::vector<unsigned char> &data,send_data_state flag,int posnum) override;
    void set_socket(QTcpSocket* socket) override;
